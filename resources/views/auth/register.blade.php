...
<div class="container">
    ...
    <form method="POST" action="{{ route('register') }}">
                ...
                <div class="login-form">
                    ...
                    <div class="sign-up-htm">
                        <div class="group">
                            ...
                            <input id="name" name="name" type="text" class="input form-control @error('name') is-invalid @enderror">
                            @error('name')
                        ...
                        <div class="group">
                            ...
                            <input id="surname" name="surname" type="text" class="input form-control @error('surname') is-invalid @enderror">
                            @error('surname')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                        ...
                        <div class="group">
                            ...
                            <input id="nick" type="text" name="nick" class="input form-control @error('nick') is-invalid @enderror">
                            @error('nick')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                        ...
                        <div class="group">
                            ...
                            <input id="email" name="email" type="text" class="input form-control @error('email') is-invalid @enderror">
                            @error('email')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                        ...
                        <div class="group">
                            ...
                            <label for="remember"><span class="icon"></span> Acepta los <a href="" data-toggle="modal" data-target="#modalTerminos">Terminos y condiciones</a> de la aplicacion.</label>
                        </div>
        ...
        <div class="modal fade login-wrap-modal" id="modalTerminos" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-lg " style="background:rgba(40,57,101,.9);" role="document">
                                <div class="">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <p> Es requisito necesario para la adquisición de los productos que se ofrecen en este sitio, que lea y acepte los siguientes Términos y Condiciones que a continuación se redactan. El uso de nuestros servicios así como la compra de nuestros productos implicará que usted ha leído y aceptado los Términos y Condiciones de Uso en el presente documento. Todas los productos que son ofrecidos por nuestro sitio web pudieran ser creadas, cobradas, enviadas o presentadas por una página web tercera y en tal caso estarían sujetas a sus propios Términos y Condiciones. En algunos casos, para adquirir un producto, será necesario el registro por parte del usuario, con ingreso de datos personales fidedignos y definición de una contraseña.
                                            ...
                                            El usuario puede elegir y cambiar la clave para su acceso de administración de la cuenta en cualquier momento, en caso de que se haya registrado y que sea necesario para la compra de alguno de nuestros productos. Photo-site.com no asume la responsabilidad en caso de que entregue dicha clave a terceros.
                                        ...
                                        <p> Photo-site a través de su sitio web concede una licencia para que los usuarios utilicen los productos que son vendidos en este sitio web de acuerdo a los Términos y Condiciones que se describen en este documento.
                                        </p>
                                        ...
                                        <p> Este Photo-site.com garantiza que la información personal que usted envía cuenta con la seguridad necesaria. Los datos ingresados por usuario o en el caso de requerir una validación de los pedidos no serán entregados a terceros, salvo que deba ser revelada en cumplimiento a una orden judicial o requerimientos legales.

                                            La suscripción a boletines de correos electrónicos publicitarios es voluntaria y podría ser seleccionada al momento de crear su cuenta.

                                            Photo-site reserva los derechos de cambiar o de modificar estos términos sin previo aviso.
                                        </p>
                                    </div>
